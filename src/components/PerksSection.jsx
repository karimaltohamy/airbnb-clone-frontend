...
const perksSection = ({ perks, setPerks, handleHead }) => {
  const handlePerks = (e) => {
  ...
  return (
    <div className="mb-3">
      {handleHead("Perks", "select all the perks of your place")}
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 mt-3 gap-3">
        <label className="p-2 flex gap-1 items-center border border-gray-300 rounded-md">
          <input
            type="checkbox"
